...
headers = {
    "PRIVATE-TOKEN": "glpat-fU_zswD1GC7uQhmGLH-M"
}
for sf in smell_files:
    ...
    gitlab_output = requests.post(f"https://git.cs.dal.ca/api/v4/projects/{67462}/issues?{query_params}",headers=headers, data=body)
